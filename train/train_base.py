...
class TrainLoop(object):
    ...
    def load_model(self):
        ...
        if self.model_pretrain_path is not None:
            
            checkpoint = torch.load(self.model_pretrain_path, map_location='cpu')
            ...
            print(f'loading pretrain checkpoint {self.model_load_path} train utils')
    ...
    def init_gpu(self):
        ...
        if self.device is None: 
            ...
            print(f'use gpus {self.device} processing.')
            self.model.to(gpu_ids[self.device])
        ...
        if self.train_dataloader is not None:
            ...
            for i, batch in enumerate(self.train_dataloader):
                ...
                if self.device is None:
                    ...
                    label = label.to(self.device).requires_grad_(False)
