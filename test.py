...
if __name__ == "__main__":
    ...
    idv_seg = VertebraSegmention(
        model_file="result/model_weight/vertebra/UNet3D_Residual_00055.pth")
    ...
    inference_image_path = r"test_data\GL195\GL195_CT_ax.nii.gz"
    save_path = "test_out" 
    ...
    # output_folder = "inference_result/none_postprocessing"
    # postproc_image_list = []
