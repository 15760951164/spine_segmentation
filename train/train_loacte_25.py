...
class loacte_dataset(Dataset):
    ...
    def __init__(self, data_dir, stack=False):
        ...
        train_ids = train_ids[0:int(train_len*0.5)]
        ...
        if self.test_dataloader is not None:
            ...
            for i, batch in enumerate(self.test_dataloader):
                ...
                if i == debug_index:
                    ...
                    heatmaps = np.sum(vol_output, axis=0)
                    sitk.WriteImage(npimage_to_sitk(heatmaps),
                                    os.path.join(debug_dir, f"epoch_{self.current_iter}_all_heatmap_pred.nii.gz"))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir',
                        type=str,
                        default="/mnt/e/wyh/vertbrae/model_weight/scn_(0,1)")
    ...
    model = SCN_mutifuse7.SCN(in_channels=1, out_channels=25, f_maps=64)
