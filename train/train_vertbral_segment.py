...
class vertebra_dataset(Dataset):
    ...
    def __init__(self, data_dir, norm=True):
    ...
    def __getitem__(self, index):
        ...
        if self.norm == True:
            img_cube_array = normalize(sitk_to_npimage(img_cube))
        else:
...
def creat_centermap():
    centermap = generator_one_heatmap((96, 96, 96), [48, 48, 48], 3.0)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir',
                        type=str,
                        default="/mnt/e/wyh/vertbrae/model_weight/vertebra_unetcb")
    ...
    parser.add_argument(
        '--train_dataset_dir',
        type=str,
        default="/mnt/e/wyh/vertbrae/train/data/idv_segmentor_96/train")

    parser.add_argument(
        '--test_dataset_dir',
        type=str,
        default="/mnt/e/wyh/vertbrae/train/data/idv_segmentor_96/test")
